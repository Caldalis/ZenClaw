...
from taskweave.agents.subagent_factory import SubagentConfig
from taskweave.types.structured_result import StructuredResult, TaskStatus, validate_result
from taskweave.types.task_graph import TaskNode
from taskweave.types.turn_snapshot import AgentNode, TurnSnapshot
from taskweave.worktree.isolator import IsolatedWorkspace, WorkspaceIsolator
from taskweave.worktree.isolated_tools import IsolatedToolSet
from taskweave.worktree.manager import WorktreeManager, WorktreeStatus
...
async def create_subagent_executor(
    ...
    """
    from taskweave.worktree.isolator import create_workspace_isolator
