...
from taskweave.agents.critic.circuit_breaker import CircuitBreakerError
from taskweave.agents.prompts import MASTER_AGENT_PROMPT
from taskweave.agents.subagent_orchestrator import SubagentOrchestrator
from taskweave.config.settings import AgentConfig, Settings
from taskweave.types.enums import AgentRole, Role
...
class MasterAgent:
    ...
    async def _wait_for_graph_result(
        ...
        if request is None:
            from taskweave.tools.builtin.create_task_graph import get_pending_graph
